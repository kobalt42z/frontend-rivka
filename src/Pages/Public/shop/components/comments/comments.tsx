    ...
    return (
        <div className='w-full  text-shadow pb-5'>
            <div className='flex w-full '>
                ...
                <div dir='ltr' className='md:mx-3'>
                    <Rating avrage={data.rating} />
                </div>

            </div>
            <p className='p-4 md:px-20'>{data.body}</p>
            <h6 className='w-full text-right text-[#B8B8B8]'>{dateFormatter(data.createdAt ?? Date.toString())}</h6>
            <ClassicHr />
        </div>
    )
}
