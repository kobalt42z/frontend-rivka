...
const MenuDrawer = ({ open, toggle, title, children }: MenuDrawerProps) => {
    return (
        <div className={` fixed top-0 bottom-0 right-0  z-40 w-[90%] min-[400px]:w-[80%] h-screens bg-[var(--main-beige-color)] p-5 ${!open && "translate-x-[115%]"} overflow-y-auto duration-700 ease-in-out `}>
